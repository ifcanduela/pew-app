...
<code><?= \pew\Pew::instance()->config()->app_folder . DS . 'views' . DS .'pages' . DS . 'index.php'; ?></code> and get started!</p>

<p>You can also change the default controller and action at 
<code><?= \pew\Pew::instance()->config()->app_folder . DS . 'config' . DS . 'routes.php' ?></code>.</p>
